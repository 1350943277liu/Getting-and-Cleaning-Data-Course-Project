...
<tr><td valign=top>`./UCI HAR Dataset/test/y_test.txt`</td><td> activity label for each observation </td></tr>
...
<tr><td valign=top>`./UCI HAR Dataset/train/y_train.txt`</td><td> activity label for each observation </td></tr>
